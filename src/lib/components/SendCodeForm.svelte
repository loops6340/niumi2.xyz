<script lang="ts">
    ...
    <div class="dark:text-dm-light-primary hidden md:block px-2 bg-background w-75">
      <div class="hidden md:flex flex-col p-2 gap-2 text-darkmode-light-primary mx-2 bg-dm-dark-secondary">
